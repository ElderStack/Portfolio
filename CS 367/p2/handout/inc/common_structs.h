...
typedef struct number_struct {
  ...
  unsigned short whole;     // Whole Portion of Number             (eg. 3.25, whole = 3) 
  unsigned short fraction;  // 16-bit Fraction Portion in Binary   (eg. 3.25, frac  = 0x4000)
