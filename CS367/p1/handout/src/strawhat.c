...
// If you want to change the default debug start, the define is in inc/strawhat_settings.h
 ...
 */
void strawhat_cleanup() {
  PRINT_STATUS("Cleaning up StrawHat environment.\n");
